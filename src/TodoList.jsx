...
function AddTodo() {
  ...
  const handleAddTodo = async (e) => {
    ...
    addTodoItem(
      ...
      parseInt(e.target.elements.value.value),
      parseInt(e.target.elements.time.value),
...
function ConfirmDeleteButton({ onConfirm }) {
  ...
  return (
    <>
      <IconButton aria-label="delete a to-do item" size="small" onClick={() => setOpen(true)}>
        <DeleteIcon />
      </IconButton>
